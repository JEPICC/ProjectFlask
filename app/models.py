...
class User(db.Model, UserMixin):
    ...
    #Relacion Uno a Muchos con Task, Atributo para obtener tareas de esta instancia
    ...
    #metodo de clase para buscar un usuario en particular
    @classmethod
...
class Task(db.Model):
    ...
    #Propiedad para reducir tamaño de caracteres en tabla html
    @property
